...
elseif($i == "popo2"){
   ...
   echo '<div class="top">Pono Popo Užduotis</div>';
   echo '<div class="main_c"><img src="img/popas.png"></div>';
   if(mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='13' && tipas='3' ")) > 149 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='8' && tipas='3' ")) > 69 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='7' && tipas='3' ")) > 89){
      echo '<div class="main_c"><div class="true">Užduotis įvygdytą! Gavai '.sk(5).' kreditus ir '.sk(5000000).' zen\'ų.</div></div>';
      mysql_query("DELETE FROM inventorius WHERE nick='$nick' && daiktas='13' && tipas='3' LIMIT 150");
      mysql_query("DELETE FROM inventorius WHERE nick='$nick' && daiktas='8' && tipas='3' LIMIT 70");
      mysql_query("DELETE FROM inventorius WHERE nick='$nick' && daiktas='7' && tipas='3' LIMIT 90");
      mysql_query("UPDATE zaidejai SET kred=kred+'5', litai=litai+'5000000' WHERE nick='$nick' ");
   } else {
...
elseif($i == "karinn"){
    ...
    if($apie['kbokstas'] == 0){
       ...
       elseif($apie['kmis'] == 1 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='13' && tipas='3' ")) < 70) $err = 'Neturi 70 Soul.';
       elseif($apie['kmis'] == 2 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='8' && tipas='3' ")) < 100) $err = 'Neturi 100 Stone.';
       elseif($apie['kmis'] == 3 && $taskai < 80) $err = 'Neturi 80 Lygio taškų.';
       elseif($apie['kmis'] == 4 && $kreditai < 25) $err = 'Neturi 25 kreditų.';
       elseif($apie['kmis'] == 5 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='5' && tipas='3' ")) < 100) $err = 'Neturi 100 Microshem.';
       elseif($apie['kmis'] == 6 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='7' && tipas='3' ")) < 110) $err = 'Neturi 110 Sayian Tail.';
       elseif($apie['kmis'] == 7 && $apie['litai'] < 5000000) $err = 'Neturi '.sk(5000000).' zen\'ų.';
       elseif($apie['kmis'] == 8 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='6' && tipas='3' ")) < 100) $err = 'Neturi 100 Fusion Tail.';
       elseif($apie['kmis'] == 9 && $lygis < 70) $err = 'Nesi pasiekęs 70 lygio.';
       elseif($apie['kmis'] == 10 && mysql_num_rows(mysql_query("SELECT * FROM inventorius WHERE nick='$nick' && daiktas='3' && tipas='3' ")) < 5) $err = 'Neturi 5 Žemės Drakono rutulių.';
       ...
       if(!empty($err)){
          ...
          if($apie['kmis'] == 1){
               ...
               mysql_query("DELETE FROM inventorius WHERE nick='$nick' && daiktas='13' && tipas='3' LIMIT 70");
          }
          elseif($apie['kmis'] == 2){
               $ko = "".sk(200000)." zen'ų.";
          ...
          elseif($apie['kmis'] == 3){
               $ko = "5 kreditus.";
               mysql_query("UPDATE zaidejai SET taskai=taskai-'80', kred=kred+'5' WHERE nick='$nick'");
          }
          elseif($apie['kmis'] == 4){
               $ko = "".sk(1000)." Jėgos.";
          ...
          elseif($apie['kmis'] == 7){
               $ko = "".sk(10)." kreditų.";
               mysql_query("UPDATE zaidejai SET kred=kred+'10', litai=litai-'5000000' WHERE nick='$nick'");
          }
          elseif($apie['kmis'] == 8){
          ...
          elseif($apie['kmis'] == 9){
               ...
               mysql_query("UPDATE zaidejai SET litai=litai+'1000000', kred=kred+'5' WHERE nick='$nick'");
          }
          elseif($apie['kmis'] == 10){
               $ko = "5% savo jėgos ir gynybos.";
               $jg = $jega*5/100;
               $gn = $gynyba*5/100;
               mysql_query("DELETE FROM inventorius WHERE nick='$nick' && daiktas='3' && tipas='3' LIMIT 5");
...
elseif($i == "pupos"){
    ...
    if($apie['kbokstas'] == 0){
        ...
        mysql_query("UPDATE zaidejai SET gyvybes='1', sptechnika='0', sptechnika_time='0', kbokstas='0' WHERE nick='$nick' ");
        for($i = 0; $i<5; $i++){
...
elseif($i == "persikelti"){
    ...
    if($apie['sptechnika'] == 0){
		...
		mysql_query("UPDATE zaidejai SET kbokstas=kbokstas+'1' WHERE nick='$nick' ");	
	}
    atgal('Atgal-?i=&Į Pradžią-game.php?i=');
}
else{
